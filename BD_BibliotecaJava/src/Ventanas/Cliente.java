...
public class Cliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CBoxCurso.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1ro Secundaria", "2do Secundaria", "3ro Secundaria", "4to Secundaria", "5to Secundaria", "6to Secundaria" }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Apellido", "CI", "Telefono", "Curso"
            }
        ));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
       ...
       String Curso = CBoxCurso.getSelectedItem().toString();
       
       
        try {
            pst = con.prepareStatement("insert into cliente(Nombre,Apellido,CI,Telefono,Curso)values(?,?,?,?,?)");
            
            pst.setString(1, Nombre);
            pst.setString(2, Apellido);
            pst.setInt(3, Integer.parseInt(CI));
            pst.setInt(4, Integer.parseInt(Telefono));
            ...
            if (k== 1)
            {
                ...
                JOptionPane.showMessageDialog(this, "Error no se a creado el Cliente");
            }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        int IdCliente = Integer.parseInt(d1.getValueAt(selectIndex, 0).toString());
        txtNombre.setText(d1.getValueAt(selectIndex, 1).toString());
        txtApellido.setText(d1.getValueAt(selectIndex, 2).toString());
        txtCI.setText(d1.getValueAt(selectIndex, 3).toString());
        txtTelefono.setText(d1.getValueAt(selectIndex, 4).toString());
        CBoxCurso.setSelectedItem(d1.getValueAt(selectIndex, 5).toString());
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
       ...
       String Curso = CBoxCurso.getSelectedItem().toString();
        ...
        try {
            pst = con.prepareStatement("update cliente set Nombre = ?,Apellido = ?,CI = ?, Telefono = ?, Curso = ? where IdCliente = ?");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            ...
            if (k== 1)
            {
                JOptionPane.showMessageDialog(this, "Cliente eliminando");
                txtNombre.setText("");
                txtApellido.setText("");
                txtCI.setText("");
                txtTelefono.setText("");
