...
public class Inventario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CBoxTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Libro", "Revista", "Tesis" }));
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtCopias, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Tipo", "Cantidad", "Copias"
            }
        ));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
       ...
       String Copias = txtCopias.getText();
        ...
        try {
            pst = con.prepareStatement("insert into inventario(Nombre,Tipo,Cantidad,Copias)values(?,?,?,?)");
            
            pst.setString(1, Nombre);
            pst.setString(2, Tipo);
            pst.setInt(3, Integer.parseInt(Cantidad));
            pst.setInt(4, Integer.parseInt(Copias));
            ...
            if (x== 1)
            {
                ...
                JOptionPane.showMessageDialog(this, "Error no se a creado el Inventario");
            }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        int IdInventario = Integer.parseInt(d1.getValueAt(selectIndex, 0).toString());
        txtNombre.setText(d1.getValueAt(selectIndex, 1).toString());
        CBoxTipo.setSelectedItem(d1.getValueAt(selectIndex, 2).toString());
        txtCantidad.setText(d1.getValueAt(selectIndex, 3).toString());
        txtCopias.setText(d1.getValueAt(selectIndex, 4).toString());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            pst = con.prepareStatement("update inventario set Nombre = ?,Tipo = ?,Cantidad = ?,Copias = ? where IdInventario = ?");
            
            pst.setString(1, Nombre);
            pst.setString(2, Tipo);
            pst.setInt(3, Integer.parseInt(Cantidad));
            pst.setInt(4, Integer.parseInt(Copias));
            pst.setInt(5, IdInventario);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            pst = con.prepareStatement("delete from Inventario Where IdInventario = ?");
            ...
            if (k== 1)
            {
                JOptionPane.showMessageDialog(this, "Inventario eliminando");
                txtNombre.setText("");
                CBoxTipo.setSelectedIndex(-1);
                txtCantidad.setText("");
                txtCopias.setText("");
